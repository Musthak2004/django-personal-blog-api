...
SECRET_KEY = 'django-insecure-%7kt!&7wjk0^$i6y9#d!yj08nb0b@-jfzo!_+-5$t&^1&l)q7x'
...
INSTALLED_APPS = [
    ...
    'blogs.apps.BlogsConfig', # new main app
]
...
STATIC_ROOT = os.path.join(BASE_DIR, "staticfiles") # collectstatic for production
